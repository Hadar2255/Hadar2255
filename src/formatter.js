...
🔐 *פרטיות*
• ${'״'}${BOT_NAME} סטטוס אבטחה${'״'} — בודק הצפנה ומצב פרטי
• ${'״'}${BOT_NAME} שכח את ההודעות האחרונות${'״'} — מוחק 5 דקות
• ${'״'}${BOT_NAME} שכח את ה־30 דקות האחרונות${'״'} — חלון מותאם
• ${'״'}${BOT_NAME} שכח הכל${'״'} — מוחק את כל ההיסטוריה של הקבוצה
